...
that used in
\rs{our previous work~\cite{quinnEffectAnisotropicViscosity2020}}{previous work~\cite{quinnEffectAnisotropicViscosity2020,quinnKelvinHelmholtzInstabilityCollapse2021}},
...
to a temperature of $10^6$ K, a typical coronal value). \todo{what's the plasma beta?} At the
...
urther detailed comparison of the models is required to fully understand this,  \todo{finish me}
