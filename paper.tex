...
\rev{The growth rate of the kink instability is, counter-intuitively, lower in
the weakly dissipative anisotropic cases, compared to the strongly dissipative
...
affected by the more complex magnetic field configuration that arises due to
the mixing caused by the nonlinear development of the flute modes (for example,
compare figures~\ref{fig:field_line_plots_iso}
and~\ref{fig:field_line_plots_swi}).}
