...
r \lessapprox 0.29$. \rev{Using
  equation~\eqref{eq:fluting_growth_rate2}, the} linear
fluting growth rate $\gamma$ is plotted as a function of $r$ at the
same time 
(Figure~\ref{fig:growth_rate_4}).
...
the spatial radial distribution of the associated resonance
function.}{\rev{Gas pressure}
