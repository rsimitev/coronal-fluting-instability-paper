...
The non-dimensionalisation scheme and values are identical to those used in~\cite{quinnEffectAnisotropicViscosity2020a}. The magnetic field is prescribed as initially straight and uniform,
\begin{equation}
\vec{B} = (0, 0, 1)^{\text{T}},
\end{equation}
