...
the kink instability e.g.~\revcite{\citep{hoodCoronalHeatingMagnetic2009}},
...
in~\revcite{\citep{priestMagnetohydrodynamicsSun2013}}. While oscillations resembling
...
In \revcite{\citep{quinnEffectAnisotropicViscosity2020,quinnKelvinHelmholtzInstabilityCollapse2021}}
...
in \revcite{\citep{hoodKinkInstabilitySolar1979}}. Where~\eqref{eq:suydams_criterion} is
...
were used in~\revcite{\citep{quinnEffectAnisotropicViscosity2020}}. In contrast, in the
...
studied
in~\citep{quinnEffectAnisotropicViscosity2020,hoodCoronalHeatingMagnetic2009,barefordShockHeatingNumerical2015}
...
in~\citep{quinnKelvinHelmholtzInstabilityCollapse2021}. The resolution used in
...
$\eta=10^{-4}$. As in~\citep{quinnEffectAnisotropicViscosity2020}, only
...
prescribed in~\citep{quinnEffectAnisotropicViscosity2020}. 
...
The faster growth of the kink compared to that measured in~\citep{quinnEffectAnisotropicViscosity2020} is attributed to the relative
...
axis.} \rev{Instead of a linear coupling, we believe that the linear kink instability is
